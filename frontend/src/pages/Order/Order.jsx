...
const Order = () => {
  const { getTotalCartAmount, token, food_list, cartItems, url,clearCartItems } = useContext(StoreContext);
...
useEffect(()=>{
  ...
  const placeOrder = async (event) => {
    ...
    let ress = await axios.post(url+"/api/order/place",orderData,{headers:{token}})
    ...
    <form onSubmit={placeOrder} className="place-order">
      <div className="place-order-left">
        ...
        <div className="delivery-time">
          ...
          <DatePicker
            selected={data.deliveryTime instanceof Date && !isNaN(data.deliveryTime) ? data.deliveryTime : new Date()}
        ...
        <div className="payment-method">
          ...
          <select value={data.paymentMethod} onChange={(event) => {
